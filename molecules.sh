...
gfortran mk20.f90 -o mk20

# 0 - 1e10 AA (0.01 - 30 um)
set lambda_begin = 	0.
set lambda_end = 	1.e10
set outfile = kmol2020.20
...
echo processing CH ...
# 12C1H -> 12 		13C1H -> 13
echo ch.asc $lambda_begin $lambda_end   2 12 -0.0047 13 -1.9707       | \
#echo chmasseron.asc $lambda_begin $lambda_end   2 12 -0.0047 13 -1.9707       | \
#echo chjorg.asc $lambda_begin $lambda_end   2 12 -0.0047 13 -1.9707       | \
        tr ' ' '\n' | mk20 >> tmp.20

echo "processing C2  ..."
# 12C12C -> 12 		12C13C -> 13	13C13C -> 33
echo c2ax.asc $lambda_begin $lambda_end   3 12 -0.0093 13 -1.9753 33 -3.9412 | \
        tr ' ' '\n' | mk20 >> tmp.20

echo c2ba.asc $lambda_begin $lambda_end   3 12 -0.0093 13 -1.9753 33 -3.9412 | \
        tr ' ' '\n' | mk20 >> tmp.20

#OLD echo c2da.asc $lambda_begin $lambda_end   3 12 -0.0093 13 -1.9753 33 -3.9412 | \
echo c2dabrookek.asc $lambda_begin $lambda_end   3 12 -0.0093 13 -1.9753 33 -3.9412 | \
        tr ' ' '\n' | mk20 >> tmp.20

echo c2ea.asc $lambda_begin $lambda_end   3 12 -0.0093 13 -1.9753 33 -3.9412 | \
        tr ' ' '\n' | mk20 >> tmp.20
        
        
echo "processing CN  ..."
# 12C14N -> 12		13C14N -> 13	12C15N -> 15
echo cnax.asc $lambda_begin $lambda_end 3 12  -0.0063 13 -1.9722 15 -2.4388 | \
        tr ' ' '\n' | mk20 >> tmp.20

echo cnbx.asc $lambda_begin $lambda_end 3 12  -0.0063 13 -1.9722 15 -2.4388 | \
        tr ' ' '\n' | mk20 >> tmp.20

echo "processing CO  ..."
# 12C16O -> 12 		13C16O -> 13	12C17O -> 17	12C18O -> 18
echo coax.asc $lambda_begin $lambda_end 4 12 -0.0057 13 -1.9717 17 -3.4249 18 -2.6929 | \
        tr ' ' '\n' | mk20 >> tmp.20
        
echo coxx.asc $lambda_begin $lambda_end 4 12 -0.0057 13 -1.9717 17 -3.4249 18 -2.6929 | \
        tr ' ' '\n' | mk20 >> tmp.20        
